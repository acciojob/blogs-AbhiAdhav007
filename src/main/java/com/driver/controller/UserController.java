...
public class UserController {
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable("usetId") int userId) {
    ...
    @PutMapping("/update")
    public ResponseEntity<Void> updateUser(@RequestParam("id") Integer id, @RequestParam("password") String password) {
